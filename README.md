...
| --- | --- | --- | --- | --- | --- |
| 1 | Cell atlas | Single cell biology | 200,000 cells stay interactive, with lasso select. | regl-scatterplot | building |
...
| 6 | City density | Geospatial | A million points as a GPU hex layer, rebinned on the client while zooming. | deck.gl + maplibre-gl | planned |
...
| `useShinyOutputStatus` | 5 | cell-atlas, market-candles, city-density, big-grid, text-lens |
